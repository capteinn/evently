    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <div id="cssmenu" style="position: absolute; right: 0;margin-right: 3%;">
        <ul class="navbar-nav">
          ...
          <li class="nav-item active"><a class="nav-link" href='#'>Tentang</a></li>
  ...
  <!-- end of Navigation -->
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-sm-4 mb-4">
          <img class="img-fluid" src="assets/images/komsi.jpg" alt="">
        </div>
        <div class="col-lg-2 col-sm-4 mb-4">
          <img class="img-fluid" src="assets/images/kmtedi.jpg" alt="">
        </div>
        <div class="col-lg-2 col-sm-4 mb-4">
          <img class="img-fluid" src="assets/images/metins.jpg" alt="">
        </div>
        <div class="col-lg-2 col-sm-4 mb-4">
          <img class="img-fluid" src="assets/images/tekjar.jpg" alt="">
        </div>
        <div class="col-lg-2 col-sm-4 mb-4">
          <img class="img-fluid" src="assets/images/hmte.jpg" alt="">
        </div>
      </div>
      <!-- /.row -->
